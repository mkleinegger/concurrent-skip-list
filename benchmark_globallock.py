...
class Benchmark:
    ...
    def run(self):
        ...
        """
        implementation_name = "global_lock"
    ...
    for disjoint in disjoint_types:
        for mix in mixes:
            bench = Benchmark(
                ...
                repetitions_per_point=1,  # Adjusted for averaging
                selection_strategy=0,  # Add a default or specified value
                basic_testing=False,  # Add a default or specified value
                seed=42,
                basedir=basedir,
                name="global_lock",
            )
